...
NodoTablero* Tablero::crearEmpresa(string empresa) {
	NodoTablero* empre = new NodoTablero(empresa, new DatosEmpleado("", "", "", ActivoRenta(), "", ""));
...
NodoTablero* Tablero::crearDepartamento(string departamento) {
	NodoTablero* depa = new NodoTablero(departamento, new DatosEmpleado("", "", "", ActivoRenta(), "", ""));
	NodoTablero* auxiliar = this->cabecera;
...
void Tablero::insertarElemento(string usernarme, string contraseña, string nombreCompleto, ActivoRenta rentas, string departamento, string empresa) {
